...
with tab3: # 뉴스
    ...
    tab1, tab2 = st.tabs(["국내", "국외"]) #국내 국외 뉴스로 탭 나눔
    with tab1: #국내 뉴스
        st.subheader("국내 증시 뉴스")
        naver_url = f'https://finance.naver.com/item/main.naver?code={selected_code}' #N pay 증권의 주소 패턴으로 url링크 주소 가져옴
        ''
    ...
    with tab2: #국외 뉴스
        ...
        st.markdown("#### :newspaper: :gray[The Wall Street Journel ]") #파싱 대신 url링크 주소 가져옴.
